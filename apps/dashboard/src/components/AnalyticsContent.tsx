        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Avg Messages/Conversation</dt>
                  <dd className="text-lg font-semibold text-gray-900">{analytics?.averageMessagesPerConversation ?? 0}</dd>
                </dl>
              </div>
            </div>
          </div>
